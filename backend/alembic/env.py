...
# Import our config and database models
...
def run_migrations_online() -> None:
    ...
    # Get or create an event loop to run the async migrations
    try:
    ...
    if loop.is_running():
        # If the loop is already running (e.g. inside test runners), run as task
